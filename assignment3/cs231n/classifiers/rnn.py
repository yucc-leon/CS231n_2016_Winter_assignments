...
class CaptioningRNN(object):
  ...
  def loss(self, features, captions):
    ...
    #(2)
    embedding_words, embedding_word_cache = word_embedding_forward(captions_in, W_embed)
    
    #(3)
    if self.cell_type=='rnn':
        h, h_cache = rnn_forward(embedding_words, initial_h, Wx, Wh, b)
    elif self.cell_type=='lstm':
        h, h_cache = lstm_forward(embedding_words, initial_h, Wx, Wh, b)
    ...
    grads['W_embed'] = word_embedding_backward(dword_vector, embedding_word_cache)
